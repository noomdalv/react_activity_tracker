...
export const fetchRecords = () => dispatch => {
  axios.get('https://trackerapi-vls.herokuapp.com/records', { withCredentials: true })
    .then(response => {
...
export const handleLogout = () => dispatch => {
  axios.delete('https://trackerapi-vls.herokuapp.com/logout', { withCredentials: true })
    .then(() => {
...
export const checkLoginStatus = () => (dispatch, getState) => {
  axios.get('https://trackerapi-vls.herokuapp.com/logged_in', { withCredentials: true })
    .then(response => {
